...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "vue": async () => {
          let pkg = await import("__mf__virtual/tipoComodoApp__prebuild__vue__prebuild__.js");
            return pkg;
        }
      ,
        "vue-router": async () => {
          let pkg = await import("__mf__virtual/tipoComodoApp__prebuild__vue_mf_2_router__prebuild__.js");
            return pkg;
        }
