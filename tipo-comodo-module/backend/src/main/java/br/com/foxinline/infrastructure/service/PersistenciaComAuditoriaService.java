...
public class PersistenciaComAuditoriaService {
    ...
    public <T extends EntidadeGenerica> Uni<Void> auditar(T entidadeAntiga, T entidadeNova, String acao,
        ...
        try {
            var field = (entidadeNova != null ? entidadeNova : entidadeAntiga).getClass().getDeclaredField("id");
            field.setAccessible(true);
            idEntidade = (Long) field.get(entidadeNova != null ? entidadeNova : entidadeAntiga);
        } catch (NoSuchFieldException | IllegalAccessException e) {
            throw new RuntimeException("Não foi possível obter o ID da entidade para auditoria", e);
        }
